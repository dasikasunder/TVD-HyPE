...
class Triangulation {
    ...
    int** cell_nb;        /* Neighbours of a given cell */
    ...
    bool* boundary_vrtx;  /* List of vertices */
    boundary_condition* boundary_id; /* Boundary id's for faces on boundary (default 0) */ 
public:
    ...
    /* For a given cell, get the three direct neighbouring cells */
    int cell_neighbour(const int& c, const int& nb) {return cell_nb[c][nb];}
    ...
    /* Check if the given vertex is at boundary */
    bool vrtx_at_boundary(const int& v) const {return boundary_vrtx[v];}
    /* Set the boundary id of face f */
    void set_boundary_cond(const int&, const boundary_condition&);
    /* Get the boundary id of face f */
    boundary_condition get_boundary_cond(const int& f) const {return boundary_id[f];}
...
double integrate_xmx0(const double&,  
                      const double&, const double&,
                      const double&, const double&,
                      const double&, const double&);

double integrate_ymy0(const double&,  
                      const double&, const double&,
                      const double&, const double&,
                      const double&, const double&);

void reflect_point(const double&, const double&,
                   const double&, const double&,
                   const double&, const double&,
                   double&, double&);
